//
// File:      $Id: NHPriorLogNormalMedianEF.cpp 2117 2013-01-21 05:20:35Z Dongfeng Zhu $
...
NHPriorLogNormalMedianEF::NHPriorLogNormalMedianEF()
{
...
NHPriorLogNormalMedianEF::NHPriorLogNormalMedianEF(double md_nu, double md_tau, double ef_nu, double ef_tau)
{
	this->ef_nu = ef_nu;
	this->ef_tau = ef_tau;
	this->md_nu = md_nu;
	this->md_tau = md_tau;
//	cout << "created lognormal med/ef prior: " << md_nu << " " << md_tau << " " << ef_nu << " " << ef_tau << endl;
}

double NHPriorLogNormalMedianEF::getLogPrior(const Parameters &params)
{
