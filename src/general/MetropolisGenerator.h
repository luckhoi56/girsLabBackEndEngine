...
public:
	...
	virtual bool increaseVariation() = 0L;
	virtual bool decreaseVariation() = 0L;
	virtual void setMinimumVariation() = 0L;
	virtual void setMaximumVariation() = 0L;

	virtual void init(int dimension) = 0L;
